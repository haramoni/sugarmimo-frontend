...
export default function NavBarMenu() {
  ...
  return (
    <header className="sm-nav-enter fixed inset-x-0 top-0 z-50 border-b border-[#e1bd8a]/15 bg-[#080808]/80 backdrop-blur-xl">
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                className="group relative whitespace-nowrap rounded-sm py-2 text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-[#d0d0d0]/75 transition-colors duration-200 hover:text-[#e1bd8a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#e1bd8a]"
              >
                {item.label}
                <span
                  className={[
          ...
          <div className="mx-auto grid max-w-7xl gap-1">
            {menuItems.map((item) => (
              <Link
                ...
                className="border-b border-[#e1bd8a]/10 py-3 font-serif text-xl text-[#e6ded1] transition hover:text-[#e1bd8a]"
              >
                {item.label}
              </Link>
            ))}
